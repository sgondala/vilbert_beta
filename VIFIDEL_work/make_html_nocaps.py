...
wvvecs2, vocablist2 = preprocess('vocab/GoogleNews-vectors-negative300.bin.gz', True, 'word2vec')
wvvecs3, vocablist3 = preprocess('crawl-300d-2M-subword.vec', False, 'fasttext')
